...
TEST_CASE("Functionality of updateGrid", "[updateGrid]"){
    const int N_mol = 10;
    const int latticesize = 20;
    const int n_iterations = 10;
    const int seed = 0;
    ...
    molecules[0].setPosition(pos1);
    molecules[1].setPosition(pos2);
    molecules[2].setPosition(pos3);
    molecules[3].setPosition(pos4);
    molecules[4].setPosition(pos5);
    molecules[5].setPosition(pos6);
    molecules[6].setPosition(pos7);
    molecules[7].setPosition(pos8);
    molecules[8].setPosition(pos9);
    molecules[9].setPosition(pos10);


    cup.setSize(51.4);
    cup.setEntropy(1.27985);

    cup.evolve(molecules);

    double precision = 1e3;
    REQUIRE((1- cup.getSize()/55.9)< precision);
    REQUIRE((1- cup.getEntropy()/1.366)<precision);
}
